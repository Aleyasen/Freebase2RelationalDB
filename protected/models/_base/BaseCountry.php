...
/**
 * This is the model base class for the table "tbl_country".
 * DO NOT MODIFY THIS FILE! It is automatically generated by giix.
 * If any changes are necessary, you must set or override the required
 * property or method in class "Country".
 *
 * Columns in table "tbl_country" available as properties of the model,
 * followed by relations of table "tbl_country" available as properties of the model.
 *
 * @property string $id
...
abstract class BaseCountry extends GxActiveRecord {
	...
	public function relations() {
		return array(
			'tvProgramCountries' => array(self::HAS_MANY, 'TvProgramCountry', 'country'),
		);
	}
