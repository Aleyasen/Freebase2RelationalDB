...
/**
 * This is the model base class for the table "tbl_tv_personality".
 * DO NOT MODIFY THIS FILE! It is automatically generated by giix.
 * If any changes are necessary, you must set or override the required
 * property or method in class "TvPersonality".
 *
 * Columns in table "tbl_tv_personality" available as properties of the model,
 ...
 *
 */
abstract class BaseTvPersonality extends GxActiveRecord {
	...
	public function tableName() {
		return 'tbl_tv_personality';
	}

	public static function label($n = 1) {
		return Yii::t('app', 'TvPersonality|TvPersonalities', $n);
	}
