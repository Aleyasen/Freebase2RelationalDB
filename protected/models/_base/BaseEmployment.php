...
/**
 * This is the model base class for the table "tbl_employment".
 * DO NOT MODIFY THIS FILE! It is automatically generated by giix.
 * If any changes are necessary, you must set or override the required
 * property or method in class "Employment".
 *
 * Columns in table "tbl_employment" available as properties of the model,
 * followed by relations of table "tbl_employment" available as properties of the model.
 *
 * @property string $id
 ...
 */
abstract class BaseEmployment extends GxActiveRecord {
	...
	public function relations() {
		return array(
			'personEmployments' => array(self::HAS_MANY, 'PersonEmployment', 'employment'),
		);
	}
