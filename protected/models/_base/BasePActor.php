...
/**
 * This is the model base class for the table "tbl_p_actor".
 * DO NOT MODIFY THIS FILE! It is automatically generated by giix.
 * If any changes are necessary, you must set or override the required
 * property or method in class "PActor".
 *
 * Columns in table "tbl_p_actor" available as properties of the model,
 ...
 *
 */
abstract class BasePActor extends GxActiveRecord {
	...
	public static function label($n = 1) {
		return Yii::t('app', 'PActor|PActors', $n);
	}
