...
/**
 * This is the model base class for the table "tbl_artwork".
 * DO NOT MODIFY THIS FILE! It is automatically generated by giix.
 * If any changes are necessary, you must set or override the required
 * property or method in class "Artwork".
 *
 * Columns in table "tbl_artwork" available as properties of the model,
 ...
 *
 */
abstract class BaseArtwork extends GxActiveRecord {
	...
	public static function label($n = 1) {
		return Yii::t('app', 'Artwork|Artworks', $n);
	}
