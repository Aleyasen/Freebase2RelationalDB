...
/**
 * This is the model base class for the table "tbl_celebrity".
 * DO NOT MODIFY THIS FILE! It is automatically generated by giix.
 * If any changes are necessary, you must set or override the required
 * property or method in class "Celebrity".
 *
 * Columns in table "tbl_celebrity" available as properties of the model,
 ...
 *
 */
abstract class BaseCelebrity extends GxActiveRecord {
	...
	public function tableName() {
		return 'tbl_celebrity';
	}

	public static function label($n = 1) {
		return Yii::t('app', 'Celebrity|Celebrities', $n);
	}
