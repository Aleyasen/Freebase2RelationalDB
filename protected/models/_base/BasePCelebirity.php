...
/**
 * This is the model base class for the table "tbl_p_celebirity".
 * DO NOT MODIFY THIS FILE! It is automatically generated by giix.
 * If any changes are necessary, you must set or override the required
 * property or method in class "PCelebirity".
 *
 * Columns in table "tbl_p_celebirity" available as properties of the model,
 ...
 *
 */
abstract class BasePCelebirity extends GxActiveRecord {
	...
	public function tableName() {
		return 'tbl_p_celebirity';
	}

	public static function label($n = 1) {
		return Yii::t('app', 'PCelebirity|PCelebirities', $n);
	}
