 ...
 * followed by relations of table "tbl_book" available as properties of the model.
 *
 * @property string $id
...
abstract class BaseBook extends GxActiveRecord {
	...
	public function relations() {
		return array(
			...
			'bookCharacters' => array(self::HAS_MANY, 'BookCharacter', 'book'),
			'bookSubjects' => array(self::HAS_MANY, 'BookSubject', 'book'),
		);
	}
