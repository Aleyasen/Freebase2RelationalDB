...
/**
 * This is the model base class for the table "tbl_cvg_genre".
 * DO NOT MODIFY THIS FILE! It is automatically generated by giix.
 * If any changes are necessary, you must set or override the required
 * property or method in class "CvgGenre".
 *
 * Columns in table "tbl_cvg_genre" available as properties of the model,
 ...
 *
 */
abstract class BaseCvgGenre extends GxActiveRecord {
	...
	public function tableName() {
		return 'tbl_cvg_genre';
	}

	public static function label($n = 1) {
		return Yii::t('app', 'CvgGenre|CvgGenres', $n);
	}
