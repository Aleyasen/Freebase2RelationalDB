 ...
 * followed by relations of table "tbl_game" available as properties of the model.
 *
 * @property string $id
...
abstract class BaseGame extends GxActiveRecord {
	...
	public function rules() {
		return array(
			array('wikiid, release_date', 'length', 'max'=>127),
			array('guid, fbid', 'length', 'max'=>63),
			array('name, description', 'safe'),
			array('wikiid, guid, fbid, name, description, release_date', 'default', 'setOnEmpty' => true, 'value' => null),
			array('id, wikiid, guid, fbid, name, description, release_date', 'safe', 'on'=>'search'),
		);
	}

	public function relations() {
		return array(
			'gameGameGenres' => array(self::HAS_MANY, 'GameGameGenre', 'game'),
		);
	}
